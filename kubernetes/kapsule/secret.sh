...
export SCW_ACCESS_KEY=$(gcloud beta secrets versions access ${SECRET_API_ACCESS_KEY_VERSION} --secret=${SECRET_API_ACCESS_KEY_NAME})
export SCW_SECRET_KEY=$(gcloud beta secrets versions access ${SECRET_API_SECRET_KEY_VERSION} --secret=${SECRET_API_SECRET_KEY_NAME})
...
export SCW_DEFAULT_PROJECT_ID=$(gcloud beta secrets versions access ${SECRET_API_PROJECT_ID_VERSION} --secret=${SECRET_API_PROJECT_ID_NAME})
