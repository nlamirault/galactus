...
resource "github_repository" "project" {
  name        = "tflint-ruleset-portefaix"
  description = "Tflint ruleset for Portefaix "
  ...
  topics = ["portefaix", "terraform", "tflint", "galactus"]
}
...
resource "github_issue_label" "area_tflint" {
...
resource "github_issue_label" "dependency_tflint" {
  repository  = github_repository.project.name
  name        = "dependency/tflint"
  description = "Dependency Tflint"
  color       = "6fcb70"
}
